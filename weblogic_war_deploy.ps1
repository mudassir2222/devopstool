...
$appPath = "/root/.jenkins/workspace/devopstool/target/devopstool.war"
$target = "AdminServer"
...
java -cp "/home/oracle/Weblogic/Oracle/Middleware/oracle_Home/wlserver/server/lib/weblogic.jar" weblogic.Deployer `
 -verbose `
 -noexit `
 -adminurl $adminUrl `
 -username $username `
